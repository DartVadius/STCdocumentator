...
class Product extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['product_capacity_hour', 'product_unit_id', 'product_category_id', 'product_weight', 'product_length', 'product_width', 'product_thickness', 'product_recipe_id'], 'integer'],
            [['product_date', 'product_update'], 'safe'],
            [['product_price'], 'number'],
            [['product_title', 'product_note'], 'string', 'max' => 255],
