...
apt-get install -y php7.1-curl php7.1-cli php7.1-intl php7.1-mysqlnd php7.1-gd php7.1-fpm php7.1-mbstring php7.1-zip php7.1-xml unzip nginx mysql-server-5.7 php.xdebug
...
mysql -uroot <<< "CREATE DATABASE documentator"
mysql -uroot <<< "CREATE DATABASE documentator"
echo "Done!"
