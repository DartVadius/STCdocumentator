 ...
 * @property string $calculation_materials_additional_data
...
class Calculation extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            ...
            [['calculation_product_capacity_hour', 'calculation_length', 'calculation_width', 'calculation_thickness',], 'number'],
    ...
    public function attributeLabels() {
        return [
            ...
            'calculation_materials_additional_data' => 'Calculation Additional Materials Data',
