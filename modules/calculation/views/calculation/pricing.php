    ...
    <?php if (!empty($categories)): ?>
        ...
        <form id="form-statement" method="POST" name="group-aggregat" class="form-group">
            ...
            <?php endforeach; ?>
                ...
                <br>
                <input type="text" name="step-count" value="1"><label for="step-count">&nbsp;Количество шагов</label>
                <br>
                <input type="text" name="partial" hidden="true" value="pricing-partial">
                <br>
