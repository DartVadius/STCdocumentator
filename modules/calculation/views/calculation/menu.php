...
<div class="row">
    <div class="col-lg-3 calculation-index">
        <p><a class="btn btn-primary btn-block" href="/calculation/calculation/profitability">Выработки</a></p>
    </div>
    <div class="col-lg-3 calculation-index">
        <p><a class="btn btn-primary btn-block" href="/calculation/calculation/group-statement">Отчет по группам</a></p>
    </div>
    <div class="col-lg-3 calculation-index">
