...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  `product_length` DECIMAL(10,2) UNSIGNED NULL,
  `product_width` DECIMAL(10,2) UNSIGNED NULL,
  `product_thickness` DECIMAL(10,2) UNSIGNED NULL,
...
CREATE TABLE IF NOT EXISTS `calculation` (
  ...
  `calculation_length` DECIMAL(10,2) UNSIGNED NULL,
  `calculation_width` DECIMAL(10,2) UNSIGNED NULL,
  `calculation_thickness` DECIMAL(10,2) UNSIGNED NULL,
